...
class FaceModelGenerator:
    def __init__(self):
        ...
        cam_width, cam_height = get_camera_dimensions(self.cap)
        ...
        # Performance optimization with exact camera dimensions
        self.target_fps = 30
        self.frame_count = 0
        self.process_resolution = (cam_width, cam_height)
        self.display_resolution = (cam_width, cam_height)
